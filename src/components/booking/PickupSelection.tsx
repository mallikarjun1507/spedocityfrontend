...
import { MapPin, Search, Clock, Home, Briefcase, ArrowLeft } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="bg-white px-6 py-4 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <h1 className="text-lg">Pickup Location</h1>
          <div className="w-16" />
        </div>
      </div>
      ...
      <div className="h-48 bg-gradient-to-br from-blue-100 to-green-100 relative">
        ...
        >
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">Interactive map will load here</p>
          </div>
        </motion.div>
        
        {/* Current Location Button */}
        <Button 
          className="absolute bottom-4 right-4 bg-white text-gray-900 shadow-lg hover:bg-gray-50"
          size="sm"
        >
